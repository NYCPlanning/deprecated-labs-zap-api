...
router.get('/', async (req, res) => {
  ...
  const textQuery = text_query ? pgp.as.format("AND (dcp_projectbrief ilike '%$1:value%' OR dcp_projectname ilike '%$1:value%' OR dcp_applicant_customer ilike '%$1:value%')", [text_query]) : '';
