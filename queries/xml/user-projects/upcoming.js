      ...
      `<entity name="dcp_project">`,
        ...
        `<link-entity name="dcp_projectlupteam" from="dcp_project" to="dcp_projectid" link-type="inner" alias="bk">`,
          ...
          `<link-entity name="contact" from="contactid" to="dcp_lupteammember" link-type="inner" alias="bl">`,
            `<filter type="and">`,
              `<condition attribute="contactid" operator="eq" uiname="BXBP" uitype="contact" value="{${contactId}}" />`,
              `<condition attribute="statecode" operator="eq" value="0" />`,
            `</filter>`,
          `</link-entity>`,
        `</link-entity>`,
        `<link-entity name="dcp_projectmilestone" from="dcp_project" to="dcp_projectid" link-type="inner" alias="bm">`,
          `<filter type="and">`,
